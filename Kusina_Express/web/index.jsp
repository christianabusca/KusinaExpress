            ...
            <div class="home-content">
                ...
                <div class="popup">
                    <div class="popup-content">
                        <div class="wrapper text-black" style="background-image: url(img/form.png);">
                            ...
                            <div class="form-container">
                                ...
                                <div class="form-inner">
                                    <form method="POST" action="${pageContext.request.contextPath}/ecommerce" class="login">
                                        <div class="field">
                                            <input name="userName" type="text" placeholder="Username" id="username" required>
                                        </div>
                                        <div class="field">
                                            <input name="password" type="password" placeholder="Password" id="passwordl" required>
                                        </div>
                                        <div class="field btn">
                                    ...
                                    <form method="POST" action="${pageContext.request.contextPath}/ecommerce" class="signup" id="form">
                                        <div class="fields">
                                            <div class="field">
                                                <input type="text" placeholder="Preferred Username" name="userName" id="usern" required>
                                            ...
                                            <div class="field">
                                                <input type="text" placeholder="Complete Address" name="location" id="location" required>
                                                <span class="error_form" id="location_error_message"></span>
                                            </div>
                                            <div class="field">
                                                <input type="text" placeholder="Birthday" class="textbox-n"
                                                       onfocus="(this.type = 'date')" name="birthday" id="date" required>
                                                <span class="error_form" id="date_error_message"></span>
                                            </div>
                                            <div class="field">
                                                <input type="number" placeholder="Mobile Number" name="number" id="number" required>
                                                <span class="error_form" id="number_error_message"></span>
                                            </div>
                                            <div class="field btn">
                                                <div class="btn-layer"></div>
                                                <button type="submit" value="Signup" id="signup">Signup</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
