        ...
        <div>
            <div class="text-center mb-2 pb-2">
                ...
                <a class="text-decoration-none d-flex justify-content-center">
                    <h1 class="text-black pt-5" style="font-weight: 600;" id="menu">Search User</h1>
                </a>
                <form class="needs-validation d-inline-block" action="${pageContext.request.contextPath}/admincontrol/search" method="GET">
                    <div class="form-group py-3">
                        <input class="form-control" type="search" name="userID" id="usID" placeholder="User ID" required>

                    </div>
                    <div class="form-group py-3">
                        <input class="form-control" type="search" name="firstN"  placeholder="User Name" id="usName" required>

                    </div>
                    <input class="btn w-100 text-white" style="background: -webkit-radial-gradient(center, circle, #110A06, #1B89DA, #110A06);" type="submit" value="Search">
                </form>
            </div>
        </div>
    </div>
                    ...
                    <table class="table table-striped table-hover" id='example' style="width:100%">
                        ...
                        <tbody>
                            ...
                            <c:forEach items="${allAdmins}" var="user">
                                <tr>
                                    <td>${user.userID}</td>
                                    <td>${user.firstN} ${user.lastN}</td>
                                    <td>${user.userRole}</td>
                                    <td>${user.accountStatus}</td>
                                    <td>${user.loginStatus}</td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/admincontrol/update/form?userID=${user.userID}" class="btn btn-sm btn-link">Edit</a>
                                        <a href="${pageContext.request.contextPath}/admincontrol/delete?userID=${user.userID}" class="btn btn-sm btn-link">Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                ...
                <div class="popup">
                    <div class="popup-content">
                        <div class="wrapper text-black" style="background-image: url(${pageContext.request.contextPath}/img/wood.jpg);">
                            ...
                            <img src="${pageContext.request.contextPath}/img/useradmin.png" class="logos-imahe">
                            ...
                            <div class="form-container">
                                <div class="form-inner">
                                    <form method="POST" action="${pageContext.request.contextPath}/admincontrol/create" class="signup" id="form3">
                                        <div class="fields">
                                            <div class="field">
                                                <input type="text" name="userID" placeholder="User ID" id="userID" 
                                                       value="<c:out value="${admin.userID}"/>" required>
                                                <span class="error_form" id="userID_error"></span>
                                            </div>
                                            <div class="field">
                                                <input type="text" name="firstN" placeholder="First Name" id="firstN" 
                                                       value="<c:out value="${admin.firstN}"/>" required>
                                                <span class="error_form" id="firstN_error"></span>
                                            </div>
                                            <div class="field">
                                                <input type="text" name="middleN" placeholder="Middle Name" id="middleN"
                                                       value="<c:out value="${admin.middleN}"/>" >
                                                <span class="error_form" id="middleN_error"></span>
                                            </div>
                                            <div class="field">
                                                <input type="text" name="lastN" placeholder="Last Name" id="lastN" 
                                                       value="<c:out value="${admin.lastN}"/>" required>
                                                <span class="error_form" id="lastN_error"></span>
                                            </div>
                                            <div class="field">
                                                <select name="userRole" id="rUser" placeholder="User Role"
                                                        value="<c:out value="${admin.userRole}"/>" required>
                                                    <option value="" disabled selected hidden>---User Roles---</option>
