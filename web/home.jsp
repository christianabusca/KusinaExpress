...
<html>
    <head>
        ...
        <!-- local files -->
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/customerhome.css">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/bootstrap.min.css">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/bootstrap.min.css.map">
        <script src="${pageContext.request.contextPath}/js/jquery-3.6.4.min.js"></script>  
        <script src="${pageContext.request.contextPath}/js/customerhome.js"></script>
...
<body>
    ...
    <div class="sidebar close">
        ...
        <ul class="nav-links">
            <li>
                <a href="${pageContext.request.contextPath}/main/homepage">
                    <i class='bx bxs-home-smile'></i>
                    <span class="link_name" name="home">Home</span>
                </a>
                <ul class="sub-menu blank">
                    <li><a name="home" class="link_name" href="${pageContext.request.contextPath}/main/homepage">Home</a></li>
                </ul>
            </li>
            <li>
                <a href="#">
        ...
        <div class="mb-2 pb-2 container position-relative">
            <div class="row py-5 gy-3 justify-content-center">
                <div class="col-sm-9 col-md-7">
                    <div class="card bg-transparent align-items-center" style="background-color: rgba(245, 245, 245, 0.4); border: transparent;" id="card">
                        <div id="logo">
            ...
            <div class="row py-5 gy-3 justify-content-center">
                <div class="col-sm-5 col-md-2">
                    <div class="card align-items-center" style="background-color: transparent">
                        <a href="#breads">
                            <img src="${pageContext.request.contextPath}/img/menu3/1.png" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                ...
                <div class="col-sm-5 col-md-2">
                    <div class="card align-items-center" style="background-color: transparent;">
                        <a href="#meals">
                            <img src="${pageContext.request.contextPath}/img/menu3/11.png" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                ...
                <div class="col-sm-5 col-md-2">
                    <div class="card align-items-center" style="background-color: transparent;">
                        <a href="#sticks">
                            <img src="${pageContext.request.contextPath}/img/menu3/31.png" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                ...
                <div class="col-sm-5 col-md-2">
                    <div class="card align-items-center" style="background-color: transparent;">
                        <a href="#desserts">
                            <img src="${pageContext.request.contextPath}/img/menu3/21.png" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                ...
                <div class="col-sm-5 col-md-2">
                    <div class="card align-items-center" style="background-color: transparent;">
                        <a href="#drinks">
                            <img src="${pageContext.request.contextPath}/img/menu3/42.png" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
    ...
    <div class="container position-relative">
        <div class="row py-5 gy-3 justify-content-center">
            <div class="col-sm-4 col-md-3">
                <div class="card align-items-center" style="background-color: transparent">
                    <a href="#breads">
                        <img src="${pageContext.request.contextPath}/img/menu3/20.png" class="card-img-top" alt="...">
                    </a>
            ...
            <div class="col-sm-4 col-md-3">
                <div class="card align-items-center" style="background-color: transparent;">
                    <a href="#meals">
                        <img src="${pageContext.request.contextPath}/img/menu3/24.png" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-4 col-md-3">
                <div class="card align-items-center" style="background-color: transparent;">
                    <a href="#sticks">
                        <img src="${pageContext.request.contextPath}/img/menu3/26.png" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-4 col-md-3">
                <div class="card align-items-center" style="background-color: transparent;">
                    <a href="#desserts">
                        <img src="${pageContext.request.contextPath}/img/menu3/13.png" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-4 col-md-3">
                <div class="card align-items-center" style="background-color: transparent;">
                    <a href="#desserts">
                        <img src="${pageContext.request.contextPath}/img/menu3/16.png" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-4 col-md-3">
                <div class="card align-items-center" style="background-color: transparent;">
                    <a href="#desserts">
                        <img src="${pageContext.request.contextPath}/img/menu3/9.png" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body text-center">
        ...
        <div class="row py-5 gy-3 justify-content-center">
            <div class="col-sm-4 col-md-3">
                <div class="card align-items-center border border-warning" style="background-color: transparent;">
                    <a href="#breads">
                        <img src="${pageContext.request.contextPath}/img/menu3/10.png" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-4 col-md-3">
                <div class="card align-items-center border border-warning" style="background-color: transparent;">
                    <a href="#sticks">
                        <img src="${pageContext.request.contextPath}/img/menu3/12.png" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-4 col-md-3">
                <div class="card align-items-center border border-warning" style="background-color: transparent;">
                    <a href="#desserts">
                        <img src="${pageContext.request.contextPath}/img/menu3/14.png" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-4 col-md-3">
                <div class="card align-items-center border border-warning" style="background-color: transparent;">
                    <a href="#desserts">
                        <img src="${pageContext.request.contextPath}/img/menu3/15.png" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-4 col-md-3">
                <div class="card align-items-center border border-warning" style="background-color: transparent;">
                    <a href="#desserts">
                        <img src="${pageContext.request.contextPath}/img/menu3/17.png" class="card-img-top" alt="...">
                    </a>
                    <div class="card-body text-center">
